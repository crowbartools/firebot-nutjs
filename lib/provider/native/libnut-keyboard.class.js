...
class KeyboardAction {
    ...
    static key(key, event, ...modifiers) {
        return new Promise((resolve, reject) => {
            try {
                ...
                if (nativeKey) {
                    libnut_core_1.default.keyToggle(nativeKey, event, modifierKeys);
                }
                resolve();
            }
            catch (e) {
    ...
    type(input) {
        return new Promise((resolve, reject) => {
            try {
                libnut_core_1.default.typeString(input);
                resolve();
            }
            catch (e) {
                reject(e);
    ...
    click(...keys) {
        return new Promise((resolve, reject) => {
            try {
                ...
                if (nativeKey) {
                    libnut_core_1.default.keyTap(nativeKey, modifierKeys);
                }
                resolve();
            }
            catch (e) {
    ...
    setKeyboardDelay(delay) {
        libnut_core_1.default.setKeyboardDelay(delay);
    }
}
